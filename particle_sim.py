...
def get_graph(p, v):
    ...
    ax.set_title("Particle Trajectory Through Earth's Van Allen Belts and Magnetosphere")
    ax.set_xlim(-100, 100)
    ax.set_ylim(-100, 100)
    ax.set_zlim(-100, 100)
    ...
    ani = FuncAnimation(fig, update, frames=Nsteps, init_func=init, interval=dt/1000)
